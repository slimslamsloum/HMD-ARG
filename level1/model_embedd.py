...
x_train, x_test, y_train, y_test = train_test_split(cls_embeddings, np.column_stack((encoded_atb_classes, encoded_mechanism)), test_size=0.3)
batch_size = 32
...
# Save model
model.save_model(path = "/home/selim/Documents/myApps/HMD-ARG/src/model_embedd")
